...
namespace SDImager
{
    public class ElevatedDragDropManager : IMessageFilter
    {
        ...
        private static readonly bool Is7OrHigher = (Environment.OSVersion.Version.Major == 6 && Environment.OSVersion.Version.Minor >= 1) || Environment.OSVersion.Version.Major > 6;
